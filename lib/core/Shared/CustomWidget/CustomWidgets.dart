...
class CustomButton extends StatelessWidget {
 ...
 @override
Widget build(BuildContext context) {
  ButtonStyle buttonStyle(BorderRadius borderRadius, Color? bgColor) {
  ...
  Widget buttonContent(BorderRadius borderRadius) {
    return Container(
  ...
  if (isBox == true) {
    return ElevatedButton(
      onPressed: onTap,
      style: buttonStyle(BorderRadius.circular(5), btcolor),
      child: buttonContent(BorderRadius.circular(5)),
    );
  } else if (isCirculer == true) {
    return ElevatedButton(
      onPressed: onTap,
      style: buttonStyle(BorderRadius.circular(20), color),
      child: buttonContent(BorderRadius.circular(20)),
    );
  } else {
    return ElevatedButton(
      onPressed: onTap,
      style: buttonStyle(BorderRadius.circular(30), color),
      child: buttonContent(BorderRadius.circular(30)),
    );
  }
}
}
